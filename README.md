These three files contain code for solving the Fokker-Planck equation (FP) using classical methods and quantum-inspired algorithms.

FokkerPlanckFiniteDifferences : Contains code for solving the FP equation using the classical finite differences method.

LCHS_algorithm : Contains code for solving the FP equation using the quantum-inspired linear combination of Hamiltonian simulation method (LCHS).

Splitstep_algorithm : Contains code for solving the FP equation using the quantum-inspired spectral split-step method.

These code files are for my honours research thesis completed in 2025.

Title:
Exploring Approaches to Solving a Linear Partial Differential
Equation Using Quantum-Inspired Algorithms
